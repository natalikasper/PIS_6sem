...
namespace ASP2
{
    public partial class _Default : Page
    {
        ...
        {
                HttpWebRequest rq = (HttpWebRequest)HttpWebRequest.Create("http://localhost:49426/KNV?ParmA=aaa&ParmB=bbbb");
                rq.Method = "Get";
        ...
        {
            HttpWebRequest rq = (HttpWebRequest)HttpWebRequest.Create("http://localhost:49426/KNV");
            rq.Method = "POST";
