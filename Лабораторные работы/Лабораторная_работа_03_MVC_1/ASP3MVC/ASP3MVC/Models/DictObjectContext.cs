...
namespace ASP3MVC.Models
{
    public class DictObjectContext
    {
        ...
        {
            List<DictObject> dictObjects = JsonConvert.DeserializeObject<List<DictObject>>(File.ReadAllText("E://Program Files//ASP//ASP3MVC//ASP3MVC//user.json", Encoding.UTF8));
            return dictObjects;
        }
        public bool Add(DictObject dictObject)
        {
            try
            {
                ...
                File.WriteAllText("E://Program Files//ASP//ASP3MVC//ASP3MVC//user.json", JsonConvert.SerializeObject(dictObjects));
                return true;
            }
            catch
            {
